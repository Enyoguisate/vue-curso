...
<form @submit.prevent="submitForm()">
    ...
    <div class="form-control">
        ...
        <!--
        <rating-control :model-value="rating" @update:modelValue="modelValueUpdated"></rating-control>
        -->
    </div>
    <div class="form-control">
        <h2>Terms and Conditions of Agreement</h2>
        <input type="checkbox" id="confirm-terms" name="confirm-terms" value="terms" v-model="terms" />
